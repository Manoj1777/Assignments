...
import org.springframework.security.core.userdetails.UserDetails; // userDetails inbuilt class in spring 
...
//		users.add(User.withDefaultPasswordEncoder().username("manoj").password("1234").roles("USER").build());
